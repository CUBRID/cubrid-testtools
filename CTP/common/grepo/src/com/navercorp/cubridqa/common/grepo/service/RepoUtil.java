...
public class RepoUtil {
	...
	public static void main(String[] args) throws Exception {
		EntryListener listener = new GeneralEntryListener() {
			...
			final JarOutputStream jout = new JarOutputStream(new FileOutputStream("e:\\a.zip"));

			@Override
			public boolean beforeFeed(String data) {
				return true;
			}
			...
			public void feed(String file, boolean isDirectory, InputStream is) {
				try {
					System.out.println(file);
					 saveZip(is, file, jout, "cubrid_common");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
			...
			@Override
			public void afterFeed(String data) {
			}
		};

		long st = System.currentTimeMillis();
		for (int i = 0; i < 1; i++) {
			// traverseRepo("E:\\git_repo_fanzaiqiang\\cubrid-testtools-internal",
			// "upstream", "develop", "cubrid_scheduler", listener);
			traverseRepo("E:\\git_repo_fanzaiqiang\\cubrid-testtools-internal", "local", "develop_improve_cub_com", "cubrid_common", "2e067e5f8e3490cadabfe44c35f1c3868291d108", listener);
		}
		long en = System.currentTimeMillis();

		System.out.println((en - st) / 1000.0);
		// traverseRepo("E:\\git_repo_fanzaiqiang\\cubrid-testtools", "origin",
		// "develop", "", "e956419b516093f867506c5e3fe5ce4a84fa97d8", listener);
	}
}
